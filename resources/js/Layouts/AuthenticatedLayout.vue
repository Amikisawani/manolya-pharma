...
<template>
    <div class="min-h-screen">
        <div class="flex min-h-screen">
            <aside
                class="mp-no-print hidden w-[15.5rem] shrink-0 flex-col lg:flex"
            ...
            <div class="flex min-w-0 flex-1 flex-col">
                <header
                    class="mp-no-print flex items-center justify-between border-b px-4 py-3 lg:px-10"
                ...
                <div v-if="showingMobile" class="mp-no-print border-b px-3 py-3 lg:hidden" style="border-color: var(--mp-line); background: #fffcf7">
                    <Link
                        v-for="item in nav"
                        :key="item.route"
                        :href="route(item.route)"
                ...
                <header v-if="$slots.header" class="mp-no-print px-4 pb-1 pt-8 lg:px-10">
                    <slot name="header" />
                </header>
                ...
                <main class="flex-1 px-4 py-5 lg:px-10 lg:py-7">
                    <div
                        v-if="flashSuccess"
                        class="mp-no-print mb-5 border px-4 py-3 text-sm"
